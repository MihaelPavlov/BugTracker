...
namespace BugTracker.Data.Migrations
{
    ...
    [Migration("20220217073153_ReworkWorkItem")]
    partial class ReworkWorkItem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BugTracker.Data.Models.WorkItem", b =>
                {
                    b.HasOne("BugTracker.Data.Models.ApplicationUser", "AssignToUser")
                        .WithMany()
                        .HasForeignKey("AssignToUserId");

                    b.HasOne("BugTracker.Data.Models.ApplicationUser", "CreateByUser")
                        .WithMany()
